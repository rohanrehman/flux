...
- 0511799: styles: remove manual 'gluon\_\_' prefix from stitches styles.
...
- c997410: Plugin: add the Bezier plugin
  ...
  ```js
  import { bezier } from '@gluon-ui/plugin-bezier'
...
- edc8847: Breaking: change how `gluon/plugin` exports components.

  ```jsx
  // before
  import { Row, Label, String } from 'gluon/plugin'

  // after
  import { Components } from 'gluon/plugin'
